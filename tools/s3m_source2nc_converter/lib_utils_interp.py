...
def apply_var_interp(var_da_in, geo_da_out, var_name=None,
    ...
    var_da_out = var_da_in.interp(interp_dict, method=interp_method)

    if var_name is not None:
        var_da_out.name = var_name
